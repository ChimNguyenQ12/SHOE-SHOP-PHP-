...
<div class="container">
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1" id="<?php if($user =="Login") echo 'Login' ?>">
        <div class="page-header">
            <h3 class="reviews">Leave your comment</h3>
            <div class="logout">
                <button class="btn btn-default btn-circle text-uppercase" type="button" onclick="document.location.href='../index.php'">
