   ...
   <div class="about_main layout_padding">
    <div class="collection_section">
    	<div class="container">
    	    ...
    	    <p class="consectetur_text">Please note deliveries are currently taking longer than usual. To check the status of an order, please visit your orders page. Thank you for your patience.</p>
    	</div>
    </div>
